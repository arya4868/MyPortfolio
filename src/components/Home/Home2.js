          ...
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body" data-aos="fade-up">
              ...
              I'm a <i className="primary-header">
                Self-Taught WebApp and Android App Developer
              </i>{" "}
              who loves solving problems and building Application.
              <br />
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links" data-aos="fade-up">
              <li className="social-icons">
                <a
                  href="https://github.com/arya4868"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="mailto:sourav.arya.1736@gmail.com"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="email"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/arya4868/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="linkedin"
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/call_me_yoursarya/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
